...
/* Global Variables */
String stop_sign_cascade_name = "./classifer/cascade.xml"; //Will need to modify this for path or put this code in the same direct
...
int main(int argc, const char ** argv)
{
	...
	stop_sign_img = imread("stop-sign-pic.jpg");
...
void detectAndDisplay(Mat frame)
{
	...
	stop_sign_cascade.detectMultiScale(frame_gray, stopSigns, 1.1, 4, 0|CV_HAAR_SCALE_IMAGE, Size(300, 300));
	cout << "Size: " << stopSigns.size() << '\n';
